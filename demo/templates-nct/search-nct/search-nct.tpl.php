      ...
      <form method="post" action="" id="searchFrm" class="row">
        <div class="col-lg-9">
          <div class="row">
            ...
            <div class="form-group col-lg-3">
              <input type="text" value="%RADIUS%" name="radius" id="radius" placeholder="{ENTER_SEARCH_RADIUS} ({KM}){MEND_SIGN}" class="form-control">
            </div>
            <div class="form-group col-lg-3">
              <input type="text" value="%PROVIDER_NAME%" name="provider_name" id="provider_name" placeholder="{PROVIDER_NAME}" class="form-control">
            </div>
            <div class="form-group col-lg-3">
        ...
        <div class="dropdown-menu filter-price-main p-0">
            ...
            <span class="min-price-h">%SLIDER_MIN_RADIUS% {KM}</span>
            <span class="max-price-h">%SLIDER_MAX_RADIUS% {KM}</span>
          </div>
                </div>
        </div>
        </div>
