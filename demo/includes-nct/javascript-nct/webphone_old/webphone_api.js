...
function start ()
{
    ...
    {
        webphone_api.helper.AddToQueue('Start', [parameters, true]);
        return false;
    }
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('Stop', [parameters]);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('Register', [parameters]);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('RegisterEx', [accounts]);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('Call', [number]);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('VideoCall', [number]);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('MuteVideo', [mute, direction]);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('SetVideoSize', [type, width, height]);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('ScreenShare', [number, screenid]);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('StopScreenShare', []);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('Hangup', []);
    else
        webphone_api.plhandler.Hangup();
}
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('Accept', []);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('Reject', []);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('Ignore', []);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('Forward', [number]);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('Conference', [number, add]);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('Transfer', [number]);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('Dtmf', [msg]);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('MuteEx', [mute, direction]);
    else
        return webphone_api.plhandler.MuteEx(state, direction);
}
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('Hold', [state]);
    else
        return webphone_api.plhandler.Hold(state);
}
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('SendChat', [number, msg]);
    else
...
{
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
        webphone_api.helper.AddToQueue('SendSms', [number, msg, from]);
    else
...
{
    if (typeof (webphone_api.plhandler) !== 'undefined' && webphone_api.plhandler !== null)
        webphone_api.plhandler.SetDevice(dev, devicename, immediate);
}
...
function setparameter (param, value)
{
    ...
    if (typeof (webphone_api.plhandler) === 'undefined' || webphone_api.plhandler === null)
    {
        ...
        webphone_api.helper.AddToQueue('SetParameter', [param, value]);
    }
    else{
...
{
    if (typeof (webphone_api.plhandler) !== 'undefined' && webphone_api.plhandler !== null)
        webphone_api.plhandler.SetLine(line);
}
...
function linetocallid (line, callback)
{
    ...
    if (typeof (webphone_api.plhandler) !== 'undefined' && webphone_api.plhandler !== null)
    {
        return webphone_api.plhandler.LineToCallID(line, callback);
    }
...
function callidtoline (callid, callback)
{
    ...
    if (typeof (webphone_api.plhandler) !== 'undefined' && webphone_api.plhandler !== null)
    {
        return webphone_api.plhandler.CallIDToLine(callid, callback);
    }
...
{
    if (typeof (webphone_api.plhandler) !== 'undefined' && webphone_api.plhandler !== null)
        return webphone_api.plhandler.CheckPresence(userlist, callback);
}
...
function getsipmessage(dir, type, callback)
{
    if ( !callback || typeof (callback) !== 'function' ) { return; }
    if (typeof (webphone_api.plhandler) !== 'undefined' && webphone_api.plhandler !== null)
        webphone_api.plhandler.GetSipMessage(dir, type,callback);
    else
 ...
 * Deprecated!  Use onAppStateChange instead ("loaded" state)!
 */
...
function LogEx(msg, err) { if (webphone_api.helper.isNull(msg)) { return; } if (!webphone_api.helper.isNull(err)) { msg = 'ERROR,' + msg + ' ' + err; } webphone_api.Log(msg); };
function Log(msg) { if (webphone_api.parameters['logtoconsole'] == 'false' || webphone_api.parameters['logtoconsole'] == false) { return; } if (webphone_api.helper.isNull(msg) || msg.length < 1) { return; } if (typeof (console) !== 'undefined' && console !== null && typeof (console.log) !== 'undefined' && console.log !== null) { if (typeof (console.error) !== 'undefined' && console.error !== null && (msg.toLowerCase()).indexOf('error') > -1) { console.error(msg); } else { console.log(msg); } } }
...
webphone_api.LoadScriptFile(webphone_api.getbasedir2() + 'webphone_config.js', function () { });
