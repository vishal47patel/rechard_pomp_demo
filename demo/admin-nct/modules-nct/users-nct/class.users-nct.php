...
class Users extends Home {
    ...
    public function dataGrid() {
        ...
        $query = "SELECT u.*
                    FROM tbl_users u WHERE u.isActive !='r' AND u.user_type = 'customer' AND (firstName LIKE ? OR lastName LIKE ? OR email LIKE ? OR DATE_FORMAT(createdDate, '" . MYSQL_DATE_FORMAT . "') LIKE ?)
